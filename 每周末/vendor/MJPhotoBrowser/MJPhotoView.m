...
- (void)photoStartLoad
{
    if (_photo.image) {
        ...
        ESWeak_(_imageView);
        @weakify(self);
        [_imageView setImageWithURL:_photo.url placeholder:_photo.placeholder options:YYWebImageOptionAllowBackgroundTask progress:^(NSInteger receivedSize, NSInteger expectedSize) {
