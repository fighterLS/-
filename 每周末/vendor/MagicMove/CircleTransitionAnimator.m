...
//  CGPathRef toPath =[UIBezierPath bezierPathWithOvalInRect:outerRect].CGPath;
    ...
    CGPoint extremePoint = CGPointMake(CGRectGetMidX(toViewController.view.bounds), CGRectGetMidY(toViewController.view.bounds));
    
    double radius = sqrt((extremePoint.x*extremePoint.x) + (extremePoint.y*extremePoint.y));
    //4
    UIBezierPath *circleMaskPathInitial=[UIBezierPath bezierPathWithOvalInRect:CGRectMake(CGRectGetMidX(toViewController.view.bounds), CGRectGetMidY(toViewController.view.bounds),0,0)];
    UIBezierPath *circleMaskPathFinal =[UIBezierPath bezierPathWithOvalInRect:CGRectInset(toViewController.view.bounds, -radius, -radius)];
