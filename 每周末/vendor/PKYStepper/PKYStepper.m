...
//    self.clipsToBounds = YES;
    ...
    self.incrementButton = [UIButton buttonWithType:UIButtonTypeCustom];
     [self.incrementButton setImage:[UIImage imageNamed:@"加号"] forState:UIControlStateNormal];
    ...
    [self.decrementButton setImage:[UIImage imageNamed:@"减号"] forState:UIControlStateNormal];
    ...
    UIColor *defaultColor = [UIColor colorWithRed:(167/255.0) green:(127/255.0) blue:(1/255.0) alpha:1.0];
